package game.rimu.data.adapter
    ...
    AndroidAdapter<ViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int)
    {
        ...
        (holder.itemView as IHeldView<T>).onAssignData(data[position], position)
    }
 ...
 */
fun interface IHeldView<T>
{
    fun onAssignData(data: T, position: Int)
}
